...
import Logo from '../../assets/images/emc-music.jpg';
    ...
    <Container data-testid="navbar-container">
      <Wrapper>
          ...
          <Menu open={showMobileMenu}>
            ...
            <MenuItem>
              <MenuItemLink active={(location.pathname === '/payments').toString()} onClick={() => setShowMobileMenu(!showMobileMenu)} to="/payments">
                <div>
                  <span>Payments</span>
                </div>
              </MenuItemLink>
